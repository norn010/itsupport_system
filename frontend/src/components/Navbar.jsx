                          ...
                          notifications.map((notif) => (
                            <div key={notif.id} onClick={() => handleMarkAsRead(notif.id, notif.related_ticket_id)}
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <span className="text-[10px] text-slate-400 mt-1.5 block">{new Date(notif.created_at).toLocaleString()}</span>
                              </div>
                            </div>
                          ))
                        )}
              ...
              {user ? (
                <>
                  <div className="mb-6 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <div className="mt-2 inline-flex items-center px-2 py-0.5 rounded-md bg-primary-100 text-primary-700 text-[10px] font-black uppercase ring-1 ring-primary-200">
                      {user.role}
                    </div>
                  </div>
